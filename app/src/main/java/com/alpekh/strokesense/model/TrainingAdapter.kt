...
class TrainingAdapter(private val onClick: (TrainingSession) -> Unit) :
    ...
    override fun onBindViewHolder(holder: TrainingViewHolder, position: Int) {
        ...
        holder.bind(session, onClick)
    }

    class TrainingViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(session: TrainingSession, onClick: (TrainingSession) -> Unit) {
